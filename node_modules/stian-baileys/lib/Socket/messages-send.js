...
export const makeMessagesSocket = (config) => {
    ...
    const getMediaType = (message) => {
        if (message.imageMessage) {
            ...
            // stian-baileys: a group status wraps a normal message, so resolve the inner media type.
            // Without this the `enc` node carries no `mediatype` and WhatsApp will not render the media.
            return getMediaType((message.groupStatusMessageV2.message || {}));
        }
        return '';
    };
